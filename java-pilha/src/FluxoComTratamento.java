...
public class FluxoComTratamento {
    ...
    public static void main(String[] args) {
        ...
        try {
        	metodo1();
        } catch (ArithmeticException | NullPointerException | MinhaExcecao exception) { // tratando múltiplas exceções com o pipe |
    ...
    private static void metodo1() throws MinhaExcecao { // adicionando throws para voltar a compilar
        System.out.println("Ini do metodo1");
        	metodo2();    
        System.out.println("Fim do metodo1");
    }

    private static void metodo2() throws MinhaExcecao { // adicionando throws para voltar a compilar
        System.out.println("Ini do metodo2");
        //Exemplo sem guardar a exceção em uma referência, pode lançá-la diretamente em uma linha só:
        throw new MinhaExcecao("Deu um erro da nova classe MinhaExceção..."); // pode enviar uma mensagem por parâmetro para o construtor da exceção
