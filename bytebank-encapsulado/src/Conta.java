...
public class Conta {
	...
	private static int total = 0; // static quer dizer que é da classe Conta, os outros atributos são da instância/objeto
...
/* O construtor é uma rotina de inicialização executada ao instanciar um objeto. 
 * Ele não é um método, e só pode ser executado uma única vez, na criação do objeto. */
